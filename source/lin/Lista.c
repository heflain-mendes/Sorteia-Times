...
int insereNaOrdem(Descritor *D, tipoNo *novoNo){
    ...
    tipoNo *atual;
    int resCom;//resultado da comparação
    ...
    if (D->inicio == NULL){/*lista está vazia*/
...
int editaNo(Descritor *D){
    ...
    return 0;//usuario n�o fez alterações
